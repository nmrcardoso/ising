...
class TuneKey {
  ...
  protected:
    ...
    if (tuneGridDim()) {
      ...
      if(param.block.x > max_threads) errorIsing("Local lattice volume is too large for device");
    }
